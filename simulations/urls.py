...
urlpatterns = [
    ...
    path('processes/dependency-map/', views.dependency_map, name='dependency-map'),
    ...
    path('<uuid:simulation_id>/report/pdf/', views.generate_pdf_report, name='simulation-pdf-report'),
    ...
    # New Endpoints
    path('<uuid:simulation_id>/rerun/', views.rerun_simulation, name='rerun-simulation'),
    path('custom-scenarios/', views.scenario_list_create, name='custom-scenario-list'),
    path('custom-scenarios/<uuid:scenario_id>/', views.scenario_detail, name='custom-scenario-detail'),
    path('comparisons/', views.comparison_list_create, name='comparison-list'),
    path('comparisons/<uuid:comparison_id>/', views.comparison_detail, name='comparison-detail'),
]