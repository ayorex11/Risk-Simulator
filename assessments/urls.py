...
urlpatterns = [
    ...
    path('templates/<uuid:template_id>/questions/', views.add_questions_to_template, name='template-add-questions'),
    path('templates/<uuid:template_id>/questions/<uuid:tq_id>/', views.remove_question_from_template, name='template-remove-question'),
